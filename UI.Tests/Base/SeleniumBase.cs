...
namespace UI.Tests.Base
{
    ...
    public abstract class SeleniumBase
    {
        ...
        protected static IWebDriver CreateFireFoxWebDriver()
        {
       ...
       public DashboardPage LoginToAdminWebsiteAsSuperAdmin()
        {
            var loginPage = new AdminWebsiteLoginPage(_driver);
            loginPage.NavigateToAdminWebsite();
            Logout();

            var page = loginPage.Login("SuperAdmin", "SuperAdmin");
            return page;
        }

        public DashboardPage LoginToAdminWebsiteAs(string username, string password)
        {
            var loginPage = new AdminWebsiteLoginPage(_driver);
            loginPage.NavigateToAdminWebsite();
            Logout();

            var page = loginPage.Login(username, username);
            return page;
        }
